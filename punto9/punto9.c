...
*Topico: Punto 9 dos matrices NxN con numeros 
*aleatorios que se restan
********************************************/
...
void resta_matriz(int n, int a[], int b[], int c[]){
...
int main(int argc, char *argv[]){
	...
	if(N < 9 && N > 0){
		...
		resta_matriz(N, matrizA, matrizB, matrizC);
		
		printf("La resta de las matrices da como resultado : \n");
